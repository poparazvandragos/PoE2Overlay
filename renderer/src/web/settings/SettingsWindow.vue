<template>
  <div>
    <div :class="$style.podium" v-if="false">
    ...
    <div v-if="false" :class="[$style.patronsHorizontal, { 'invisible': true }]" :onMouseenter="showPodium">
    ...
    <div :class="$style.window" class="grow layout-column" :onMouseenter="hidePodium">
      ...
      <div class="flex grow min-h-0">
        <div class="pl-2 pt-2 bg-gray-900 flex flex-col gap-1" style="min-width: 10rem;">
          ...
          <div v-if="false" class="text-gray-400 text-center mt-auto pr-3 pt-4 pb-12"
