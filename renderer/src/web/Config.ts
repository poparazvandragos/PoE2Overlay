...
export async function initConfig() {
  ...
  try {
    ...
    // TODO
    // dialog.showErrorBox(
    //   'PoE2 Overlay - Incompatible configuration',
    //   // ----------------------
    //   'You are trying to use an older version of PoE2 Overlay with a newer incompatible configuration file.\n' +
...
export function poeWebApi() {
  ...
  switch (language) {
    ...
    case 'ko': return 'poe2.game.daum.net'
  }
}
...
export const defaultConfig = (): Config => ({
  ...
  widgets: [
    ...
    // --- DEFAULT ---
    {
      ...
      entries: [
        { id: 1, name: '', text: '"increased Magic Monsters"', hotkey: null },
        { id: 2, name: '', text: '"increased number of Rare Monsters"', hotkey: null },
      ]
